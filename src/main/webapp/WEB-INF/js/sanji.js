...
$(
    function () {
        ...
        $.post(url, function (result) {
                ...
                time.className = "row";
                time.innerHTML = "<p><h6 style='color:white'>time：" + utime + "<h6></p><p><h6 style='color:white'>producer：" + result.data.creater + "<h6></p><p> <h6 style='color:gray'>tag：</h6><div class='btn-group btn-group-xs' id='tags'></div> </h6></p>";
                ...
                if (result.data.stat == '1') {
                    spc.innerHTML = "<h2>purchase" + result.data.name + ":¥" + result.data.price + "</h2>";
...
function move(to) {
    ...
    if (to == "left")
        imgList.scrollLeft -= 126;
    else imgList.scrollLeft += 126;
}
