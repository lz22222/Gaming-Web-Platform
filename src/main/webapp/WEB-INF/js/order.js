...
function getpaid(pagenum) {
    $.post("/order/paid/" + pagenum, function (result) {
            if (result.data.order[0]) {
                ...
                mytable.innerHTML = "<thead id='myThead' style='color: #67c1f5'><th width='25%'>Number</th><th width='35%'>Total Price</th><th width='30%'>Order Time</th></thead><tbody id='myTbody' style='color:#630'></tbody>";
...
function getnotpay(pagenum) {
    $.post("/order/notpay/" + pagenum, function (result) {
            if (result.data.order[0]) {
                ...
                mytable.id = "myTable1";
                mytable.className = "table";
                mytable.innerHTML = "<thead id='myThead1' style='color: #67c1f5'><th width='25%'>Number</th><th width='35%'>Total Price</th><th width='30%'>Order Time</th></thead><tbody id='myTbody1' style='color:#630'></tbody>";
                ...
                while (result.data.order[i]) {
                    ...
                    row.innerHTML = "<td>" +
                        ...
                        "</td><td>" + prices + "</td><td>" + time + "</td><th><button class='btn smargin' onclick='topay(" + oid + ")'>pay</button></th>" +
...
function getcancel(pagenum) {
    $.post("/order/cancel/" + pagenum, function (result) {
            if (result.data.order[0]) {
                ...
                mytable.id = "myTable2";
                mytable.className = "table";
                mytable.innerHTML = "<thead id='myThead2' style='color: #67c1f5'><th width='25%'>Number</th><th width='35%'>Total Price</th><th width='30%'>Order Time</th></thead><tbody id='myTbody2' style='color:#630'></tbody>";
