        ...
        <div class="col-xs-10 col-sm-10 col-md-10">
            ...
            <div class="row">
                <div id="carousel_1" class="carousel slide" data-ride="carousel">
                    ...
                    <a class="left carousel-control" href="#carousel_1" role="button" data-slide="prev"> <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <span class="sr-only">Previous</span>
                    </a>
            ...
            <div class="row">
                <div class="tit tit_1"> Relax for a While</div>
            </div>
            ...
            <div class="row zx">
                <div class="col-md-8">
                    <ul id="myTab" class="nav nav-tabs">
                        <li role="presentation"><a href="#home" data-toggle="tab">New and Popular Items</a></li>
